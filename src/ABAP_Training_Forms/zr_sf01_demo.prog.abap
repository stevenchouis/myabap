...
*&---------------------------------------------------------------*
*& SF01 - Smartform 呼叫端骨架示範
*& 查出 ZSF_01_HELLO 動態產生的 Function Module 名稱，
...
IF sy-subrc <> 0.
  WRITE: / '找不到表單 ZSF_01_HELLO 或尚未啟用，請先在 SMARTFORMS 建立並啟用。'.
  RETURN.
ENDIF.
...
ELSE.
  WRITE: / '呼叫成功，請確認預覽畫面或 Spool 是否印出 Hello Smartform!'.
ENDIF.
