*&---------------------------------------------------------------------*
*& Report  ZDQM0001_1
*& 檢驗特性資料轉檔程式.(BDC)  (Copy of ZDQM0001)
*&---------------------------------------------------------------------*
REPORT ZDQM0001_1 message-id ZQMM01 LINE-SIZE 200.
...
*&---------------------------------------------------------------------*
*       將錯誤資料下載至前端檔案 (原 gui_download 巨集改寫)
*----------------------------------------------------------------------*
FORM download_error_file.
  DATA: lv_filename TYPE string.
  lv_filename = p_ename.
